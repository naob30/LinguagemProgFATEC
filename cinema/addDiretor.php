...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    header('Location: addDiretor.php');
    exit();
}
?>
...
<body>
    <header>
        <h3 class="fs-3 text-uppercase text-center" style="color: white;">Cadastrar diretor do filme</h3>
    </header>

    <div class="d-flex justify-content-center banner">
        <div class="card d-flex justify-content-center">
            <div class="card-header font-monospace">
                CADASTRAR DIRETOR DO FILME
            </div>
            <div class="card-body">
                <form action="" method="POST">
                    <div class="input-group flex-nowrap">
                        <span class="input-group-text" id="addon-wrapping"><i class="bi bi-person"></i></span>
                        <input type="text" class="form-control font-monospace" placeholder="Digite o diretor do filme..." aria-label="Username" aria-describedby="addon-wrapping" name="nome" required>
                    </div>

                    <input type="submit" value="CADASTRAR DIRETOR" class="btn btn-outline-primary">
                </form>
            </div>
        </div>
    </div>
