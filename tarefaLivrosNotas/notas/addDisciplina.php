...
<body>
    <header>
        <h3 class="text-uppercase text-center" style="color: white; font-size: 38px">Cadastrar DISCIPLINA</h3>
    </header>
            ...
            <div class="card-body">
                <form action="" method="POST">
                    <div class="input-group flex-nowrap">
                        ...
                        <input type="text" class="form-control font-monospace" placeholder="Digite o nome da disciplina..." aria-label="Username" aria-describedby="addon-wrapping" name="disciplina" required>
                    </div>

                    <input type="submit" value="CADASTRAR DISCIPLINA" class="btn btn-outline-primary">
                </form>
            </div>
        </div>
    </div>
