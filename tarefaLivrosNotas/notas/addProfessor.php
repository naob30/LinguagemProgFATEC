...
<body>
    <header>
        <h3 class="text-uppercase text-center" style="color: white; font-size: 38px">Cadastrar professor</h3>
    </header>
            ...
            <div class="card-body">
                <form action="" method="POST">
                    <div class="input-group flex-nowrap">
                        ...
                        <input type="text" class="form-control font-monospace" placeholder="Digite o nome do professor..." aria-label="Username" aria-describedby="addon-wrapping" name="nomeProfessor" required>
                    </div>

                    <input type="submit" value="CADASTRAR PROFESSOR" class="btn btn-outline-primary">
                </form>
            </div>
        </div>
    </div>
